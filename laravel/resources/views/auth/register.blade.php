...
<div class="row ">
  ...
  <div class="card-body">
    ...
    <form method="POST" action="{{ url('register') }}">
      ...
      @endif      
         <div class="mb-3">
            <label for="name" class="form-label" style="font-family:'futura-book', monospace">Nama</label>
            <input type="text" class="form-control" id="name" name="name" style="font-family:'futura-book', monospace">
        </div>
        <div class="mb-3">
            <label for="exampleInputEmail1" class="form-label" style="font-family:'futura-book', monospace">Alamat email</label>
            <input type="email" class="form-control" id="exampleInputEmail1" name="email" style="font-family:'futura-book', monospace">
        </div>
        <div class="mb-3">
            <label for="exampleInputPassword1" class="form-label" style="font-family:'futura-book', monospace">Kata sandi</label>
